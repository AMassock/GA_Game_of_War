...
function compare(playerOne, playerTwo) {
    ...
    if(playerOne.cardOne.card.score > playerTwo.cardTwo.card.score) {

        console.log(`${playerOne} wins with ${playerOne.cardOne}`);

    } else if(playerOne.cardOne.Card.score < playerTwo.Card.score) {

        console.log(`${playerTwo} wins with ${playerTwo.cardTwo}`);

    } else if(playerOne.cardOne.Card.score === playerTwo.cardTwo.Card.score) {

        console.log(`${playerOne} and ${playerTwo} tie with ${playerOne.cardOne}`);
